...
# ===== 请求/响应模型 =====
# pragma: no cover  MC80OmFIVnBZMlhucUx2b2pZbmt1cm82TURjMU53PT06YzRmMjkzNzk=
...
# type: ignore  MS80OmFIVnBZMlhucUx2b2pZbmt1cm82TURjMU53PT06YzRmMjkzNzk=
...
# pylint: disable  Mi80OmFIVnBZMlhucUx2b2pZbmt1cm82TURjMU53PT06YzRmMjkzNzk=
    ...
    try:
        ...
        for i, qa_create in enumerate(qa_pairs):
            try:
                ...
                used_tables = qa_create.used_tables or extract_tables_from_sql(qa_create.sql)
                mentioned_entities = qa_create.mentioned_entities or extract_entities_from_question(qa_create.question)
# pylint: disable  My80OmFIVnBZMlhucUx2b2pZbmt1cm82TURjMU53PT06YzRmMjkzNzk=
