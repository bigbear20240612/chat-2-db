...
def analyze_data_for_chart(data: Dict[str, Any], query_context: str) -> Dict[str, Any]:
    ...
    try:
        ...
        text_columns = []
        date_columns = []
# fmt: off  MC80OmFIVnBZMlhucUx2b2pZbmt1cm82VjJwVlZ3PT06ZDNmNmM5YjM=
...
# pragma: no cover  MS80OmFIVnBZMlhucUx2b2pZbmt1cm82VjJwVlZ3PT06ZDNmNmM5YjM=
...
def should_generate_chart(query: str, data: Dict[str, Any]) -> Dict[str, Any]:
    ...
    try:
        ...
        rows = data.get("rows", [])
        columns = data.get("columns", [])
# noqa  Mi80OmFIVnBZMlhucUx2b2pZbmt1cm82VjJwVlZ3PT06ZDNmNmM5YjM=
...
# noqa  My80OmFIVnBZMlhucUx2b2pZbmt1cm82VjJwVlZ3PT06ZDNmNmM5YjM=
