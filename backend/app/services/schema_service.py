...
# pylint: disable  MC80OmFIVnBZMlhucUx2b2pZbmt1cm82YzJaQ1FRPT06YTA0ZTNhM2I=
...
# pragma: no cover  MS80OmFIVnBZMlhucUx2b2pZbmt1cm82YzJaQ1FRPT06YTA0ZTNhM2I=
...
def discover_mysql_schema(inspector) -> List[Dict[str, Any]]:
    ...
    for table_name in tables:
        ...
        try:
            columns = inspector.get_columns(table_name)
            print(f"Found {len(columns)} columns in {table_name}")
# noqa  Mi80OmFIVnBZMlhucUx2b2pZbmt1cm82YzJaQ1FRPT06YTA0ZTNhM2I=
...
# fmt: off  My80OmFIVnBZMlhucUx2b2pZbmt1cm82YzJaQ1FRPT06YTA0ZTNhM2I=
