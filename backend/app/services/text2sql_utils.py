...
# pylint: disable  MC80OmFIVnBZMlhucUx2b2pZbmt1cm82UnpoSlN3PT06NDM2OWVlOTQ=
...
def filter_expanded_tables_with_llm(query: str, query_analysis: Dict[str, Any],
    ...
    try:
        ...
        # 如果发生任何错误，包含所有扩展表
        return set(expanded_tables)
# type: ignore  MS80OmFIVnBZMlhucUx2b2pZbmt1cm82UnpoSlN3PT06NDM2OWVlOTQ=
...
def format_schema_for_prompt(schema_context: Dict[str, Any]) -> str:
    ...
    for table in tables:
        ...
        schema_str += "\n"
# pylint: disable  Mi80OmFIVnBZMlhucUx2b2pZbmt1cm82UnpoSlN3PT06NDM2OWVlOTQ=
...
# fmt: off  My80OmFIVnBZMlhucUx2b2pZbmt1cm82UnpoSlN3PT06NDM2OWVlOTQ=
